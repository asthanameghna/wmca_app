...
def app():
    ...
    with st.sidebar:
        ...
        [![Repo](https://badgen.net/badge/Meghna%20Ashthana/LinkedIn/blue)](https://www.linkedin.com/in/meghna-asthana-1452b097/) 
        ...
        st.image("img\DSSGxUK_logo.png")
        col1, col2, col3 = st.columns([1,1,1])
        with col1:
            st.image("img\West_Midlands_Combined_Authority_logo.svg.png")
        with col2:
            st.image("img\pure_leapfrog_logo.png")
        with col3:
            st.image("img\WarwickLogo.png")
